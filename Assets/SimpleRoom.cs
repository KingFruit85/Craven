...
public class SimpleRoom : MonoBehaviour
{
    ...
    {
        var exitSquare = Instantiate(Resources.Load("ExitSquare_LOCKED") as GameObject, ExitTile.transform.position, Quaternion.identity) as GameObject;
        exitSquare.transform.parent = gameObject.transform.parent;
